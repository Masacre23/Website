...
class TimeSpan(
    ...
    companion object {
        ...
        private const val MILLIS_PER_MINUTE = MILLIS_PER_SECOND * 60.0
        private const val MILLIS_PER_HOUR = MILLIS_PER_MINUTE * 60.0
        private const val MILLIS_PER_DAY = MILLIS_PER_HOUR * 24.0
        private const val MILLIS_PER_WEEK = MILLIS_PER_DAY * 7.0
